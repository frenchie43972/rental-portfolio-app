              ...
              <div className="relative ml-3">
                <div>
                  <button
                    ...
                    aria-expanded="false"
                    aria-haspopup="true"
                    // Sets the previous state on click so if it is showing, it hides
                ...
                {/* <!-- Profile dropdown --> */}
                {/* Wrapped the dropdown in the coditional that calls the current state from
                what is stired in the onClick (false or true) */}
                {isProfileMenuOpen && (
                  <div
                  id="user-menu"
